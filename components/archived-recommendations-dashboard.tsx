...
export function ArchivedRecommendationsDashboard() {
  ...
  const selectedStatuses = new Set(["Archived"])
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-semibold text-foreground">Archived Recommendations</h1>
      </div>
            ...
            <Popover open={openFilters.date} onOpenChange={(open) => toggleFilter("date", open)}>
              ...
              >
                <div className="p-3 space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="font-semibold text-sm">Date Archived</h4>
                    <Button
                      variant="ghost"
                      size="sm"
