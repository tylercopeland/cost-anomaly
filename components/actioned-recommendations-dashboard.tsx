...
export function ActionedRecommendationsDashboard() {
  ...
  const selectedStatuses = new Set(["Actioned"])
  ...
  const actionedRecommendations = allRecommendations.filter((item) => item.status === "Actioned")
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-semibold text-foreground">Actioned Recommendations</h1>
      </div>
            ...
            <Popover open={openFilters.date} onOpenChange={(open) => toggleFilter("date", open)}>
              ...
              >
                <div className="p-3 space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="font-semibold text-sm">Date Actioned</h4>
                    <Button
                      variant="ghost"
                      size="sm"
