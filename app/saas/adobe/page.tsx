    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 overflow-auto">
          {categoryFilter ? (
            <OptimizationDashboard initialCategoryFilter={categoryFilter} initialProvider="adobe" dataSource="saas" />
          ) : (
            <div className="p-4">
              <OptimizationContent selectedStatuses={defaultStatuses} initialProvider="adobe" />
            </div>
          )}
        </main>
      </div>
